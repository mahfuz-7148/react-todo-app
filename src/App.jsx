...
export const App = () => {
  ...
  if (isLoading) {
    return (
      <div className="fixed inset-0 bg-linear-to-br from-slate-900 via-indigo-950 to-purple-950 flex items-center justify-center z-50">
        <div className="text-center">
          ...
          {/* Loading Text */}
          <h2 className="text-2xl font-bold bg-linear-to-r from-cyan-400 via-blue-500 to-purple-500 bg-clip-text text-transparent mb-3">
            Loading Your Tasks
          </h2>
